...
Resolved source is cached at `.anvil-review-loop/knowledge.md`. The checklist is cached at `.anvil-review-loop/checklist.md` if not already present. Later runs may merge, not overwrite blindly.
